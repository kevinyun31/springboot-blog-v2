insert into user_tb(username, password, email, pic_url) values('ssar', '1234', 'ssar@nate.com', '냐옹이.jpg');
insert into user_tb(username, password, email, pic_url) values('cos', '1234', 'cos@nate.com', '냐옹이.jpg');
